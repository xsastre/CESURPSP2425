package docencia.xaviersastre.dam.psp.ut02.bany;
/* En aquest exemple no gestionam la coa */
...
public class Exemple_bany_synchronized_method {
    ...
    public static void main(String[] args) throws InterruptedException{
        ...
        Persona Miquel=new Persona("Miquel",bany);
